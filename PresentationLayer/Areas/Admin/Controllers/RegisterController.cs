        ...
        public async Task<IActionResult> SignUp(AppUserRegisterDto appUserRegisterDto) //AppUserRegisterDto bu modeli kullanma amacımız sadece gerekli propertyleri kullanmak için 
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    MailboxAddress mailboxAddressFrom = new MailboxAddress("DoraSoft Araştırma ve Danışmanlık", "scakar542@gmail.com");//kimden geleceği isim ve adres
                    ...
                    client.Authenticate("scakar542@gmail.com", "kgwsrmwelpbsdxwx");//mail ve mailde oluşturduğun güvenlik kodu
